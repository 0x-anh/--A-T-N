    ...
    <div className="fixed inset-0 z-[500] flex items-center justify-center p-6">
      ...
      >
        <div className="flex flex-col text-center space-y-6 mb-12">
            ...
            <h3 className="text-xl font-black text-slate-950 tracking-tight uppercase leading-none">Khởi Tạo Không Gian</h3>
          ...
          <div className="space-y-10">
            ...
            <div className="flex gap-4">
              ...
              <button onClick={onClose} className="px-8 text-[10px] font-black text-slate-400 hover:text-slate-950 transition-colors uppercase tracking-[0.3em] font-mono">HỦY BỎ</button>
            </div>
        </div>
      </motion.div>
    </div>
